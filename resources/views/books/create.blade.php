    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Add New Book</span>
            </div>
            <h1 class="page-title">
                    ...
                    <form action="{{ route('books.store') }}" method="POST" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('published_year') is-invalid @enderror" id="published_year" name="published_year" value="{{ old('published_year') }}" min="1000">
