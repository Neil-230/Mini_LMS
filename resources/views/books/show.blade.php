    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <h1 class="page-title">
                    <i class="fas fa-book-open me-2" style="color: #4f46e5;"></i> {{ $book->title }}
                </h1>
                <p class="page-subtitle">ISBN: {{ $book->isbn }}</p>
            </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4 d-flex flex-column">
                <div class="glass-card info-card flex-grow-1">
                    <div class="info-header">
                        <h5><i class="fas fa-info-circle me-2"></i> Book Information</h5>
                    </div>
                    <div class="info-body">
                        <!-- Book Icon -->
                        <div class="book-icon">
                        ...
                        <div class="info-item">
                            <div class="info-label">Published Year</div>
                            <div class="info-value">{{ $book->published_year ?? 'N/A' }}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Total Quantity</div>
                            <div class="info-value">{{ $book->quantity }}</div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Available Count</div>
            ...
            <div class="col-md-8">
                <div class="table-card">
                    <div class="table-header">
                        <h5><i class="fas fa-history me-2"></i> Borrowing History</h5>
                    </div>
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                <div class="empty-state">
                                                    ...
                                                    <p class="mb-0">No borrowing records found for this book</p>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
