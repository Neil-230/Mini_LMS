...
<div class="page-container">
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-md-8">
                <h1 class="page-title">
                    <i class="fas fa-graduation-cap me-2" style="color: #4f46e5;"></i> Students Management
                </h1>
                <p class="page-subtitle">Manage and track all student records in the system</p>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="bg-primary bg-opacity-10 rounded-circle me-2" style="width: 35px; height: 35px; display: flex; align-items: center; justify-content: center;">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-envelope me-2 text-muted" style="font-size: 0.8rem;"></i>
                                    ...
                                    <td>
                                        <span class="text-muted">{{ Str::limit($student->address, 30) }}</span>
                                    </td>
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('students.show', $student) }}" class="btn btn-icon btn-view">
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div class="empty-state">
                                            ...
                                            <p>No students found. <a href="{{ route('students.create') }}" class="text-primary fw-bold">Create one now!</a></p>
                                            <a href="{{ route('students.create') }}" class="btn btn-add">
